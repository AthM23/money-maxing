...
export function renderOverview(app, o) {
  ...
  return h("section", {},
    h("div", { class: "pagehead" },
      ...
      h("div", { class: "actions" },
        h("button", { class: "btn white", disabled: o.read_only, on: { click: () => learn(app) } }, icon("book", 16), "Learn from last quarter"),
        h("button", { class: "btn ink", disabled: o.read_only, on: { click: () => run(app) } }, icon("play", 15), "Run the code tier"))),
