...
/** `--stage min|all` `--baseline` `--seed N` `--outcomes path.json` `--pack ap`. Throws on anything
 *  it doesn't recognise — an unrecognised invocation is a harness error, not a silent no-op. */
