...
1. The one paid step (Haiku first: about 100 seconds and 10 cents when it settles it; the tier caps sum to \$2.25):
     env -u ANTHROPIC_API_KEY pnpm worker $OUT/prepared.db --intent $MAIN
