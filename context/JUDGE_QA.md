...
| Isn't base Qwen a strawman? | It is the floor, and it is labelled as that. The comparison that matters is on the same chart: Haiku 4.5 with the whole schema in every prompt, 0.962 against our 0.972, and Haiku wins exact match 74.2% to 70.0%. |
